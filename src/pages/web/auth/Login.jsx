...
const Login = () => {
  ...
  return (
    <Tabs active={active} onChange={handleChange}>
      <Tab title="Login">
      <div className="w-[500px] container mx-auto mt-10">
    ...
    //   <div className="w-full flex items-center justify-center md:w-1/2    border-gray-400">
    //     <form>
    //       <div className="px-10 py-10 rounded-3xl border-2 bg-white border-gray-100">
    //         <h1 className="text-5xl text-center font-semibold">Login</h1>
    //         <div className="mt-8">
    ...
    //     </form>
    //   </div>
    //   <div className="hidden relative md:flex h-full w-1/2 items-center justify-center ">
    //   <form>
    //         <div className="px-10 py-10 rounded-3xl border-2 bg-white border-gray-100">
    //           <h1 className="text-5xl text-center font-semibold">Signup</h1>
    //           <div className="mt-8">
