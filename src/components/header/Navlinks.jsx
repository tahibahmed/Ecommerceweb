        ...
        {links.map((link) => (
          <div>
            <div className="px-3 text-left md:cursor-pointer group">
              ...
              {link.submenu && (
                <div>
                  <div className="absolute top-20 left-10 hidden group-hover:md:block w-full hover:md:block border-b-2 z-10">
                    <div className="py-3">
                      <div
                    ...
                    <div className="bg-white p-5 grid grid-cols-5 gap-5">
